...
#SBATCH --output=slurm_out/workflowr_xenium_human_breast_cancer.out
#SBATCH --error=slurm_out/workflowr_xenium_human_breast_cancer.err
...
Rscript -e "
rmarkdown::render(
  input = 'xenium-human-breast-cancer-analysis.Rmd',
  output_dir = '../docs',
  knit_root_dir = '.',
